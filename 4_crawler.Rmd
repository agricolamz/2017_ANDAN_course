...
* Скачайте тексты всех статей (напишите функцию, но запускайте на четырех статьях). Когда получиться, возьмите с флешки или [отсюда](https://goo.gl/jb8ePY) все данные.
