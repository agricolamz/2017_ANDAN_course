...
* Скачайте тексты всех статей (напишите функцию, но запускайте на четырех статьях). Когда получится, возьмите с флешки или [отсюда](https://goo.gl/93kdsL) все данные.
