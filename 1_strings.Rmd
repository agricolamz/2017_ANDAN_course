...
[В данных по продолжительности сна](https://goo.gl/dpCSV2) (1.1_sleep_hours.csv)[^1] две переменных: код испытуемого и среднее время сна. Попробуйте сделать следующий график:
...
[^1]: Если у Вас не получается считать файл, попробуйте добавлять разные аргументы к `read.csv`: `encoding="UTF-8"` или `fileEncoding = "UTF-8"`… Я надеюсь, поможет…
